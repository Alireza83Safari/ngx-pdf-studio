...
وضعیت کلی: **موتور کامل (۷۱۶ تست سبز)، دیزاینر WYSIWYG با گالری قالب، pipeline انتشار آماده.**
این فایل کارهای باقی‌مونده رو نسبت به اسپک
(`pdf-studio-build-prompt.md`، فازهای §15) فهرست می‌کنه.

> **کارهای رابطِ دیزاینر در [DESIGNER-UX-TODO.md](DESIGNER-UX-TODO.md) دنبال می‌شن.**
> اون فایل از یک بازبینیِ کاملِ محیطِ طراحی اومده و شکافِ «موتور جلوتر از رابط» رو می‌بنده؛
> فازهای ۰ و ۱ اون تموم شدن. آیتم‌های Phase 4/4A پایین که با ⬜ مونده بودن (rulers،
> دستگیرهٔ چرخش، a11y، آپلود تصویر/فونت، …) اونجا بسته شدن یا برنامه دارن.
...
شفاف برای تعامل، و اندازه‌گیری با **همان فونتی** که PDF جاسازی می‌کند)،
**جعبه‌ابزار ۱۲ الِمانی** (متن/فیلد/مستطیل/خط/بیضی/تصویر/بارکد/QR/چارت/جدول/فیلد
برچسب‌دار/شماره صفحه)، **snap به grid + لبهٔ الِمان‌ها با خط راهنمای زنده** (Alt=خاموش)،
**multi-select با Shift**، **۸ دستگیرهٔ تغییر اندازه + دستگیرهٔ چرخش**،
**zoom** (دکمه + Ctrl+چرخ‌موس)، **nudge با فلش‌ها** (Shift=۱۰pt)، **Ctrl+D کپی**،
inspector کامل (تایپوگرافی، جعبه و کادر، شرط‌ها)، **آپلود لوگو و فونت**،
**تنظیمات صفحه** (حاشیه/واحد/ارقام/تقویم)، **هشدارهای زندهٔ موتور**، undo/redo،
پیش‌نمایش زنده، ورود/خروجی JSON، دانلود PDF. smoke-test خودکار jsdom دارد.
...
- ✅ **جابه‌جایی/resize با ۸ دستگیره + چرخش روی بوم** (designer-ux ۱.۸) + drag از toolbox
...
- ✅ **گالری قالب آماده** — دکمهٔ «🗂 قالب‌ها» با **بندانگشتی WYSIWYG زنده** (رندر واقعی موتور)؛ **۲۲ قالب** فارسی/RTL معتبر (صفر issue/diagnostic) در **۶ دسته** (مالی و فروش، اداری و منابع انسانی، گزارش و تحلیل، بازاریابی و رویداد، برچسب و کارت) — فاکتور، پیش‌فاکتور، رسید، گزارش فروش، سربرگ، برچسب محصول، لیست بسته‌بندی، کارت ویزیت، منوی رستوران، گواهی‌نامه و…؛ هر کدام با دادهٔ نمونهٔ خودش، با جست‌وجو و تمِ رنگیِ قابل‌تعویض — ⬜ style presets سراسری
